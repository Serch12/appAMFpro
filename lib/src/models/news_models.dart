...
class AfiliadosResponse {
    ...
    factory AfiliadosResponse.fromJson(String str) => AfiliadosResponse.fromMap(json.decode(str));

    factory AfiliadosResponse.fromMap(Map<String, dynamic> json) => AfiliadosResponse(
        data: json["data"] == null ? [] : List<Afiliados?>.from(json["data"]!.map((x) => Afiliados.fromJson(x))),
...
class Afiliados {
    ...
    factory Afiliados.fromRawJson(String str) => Afiliados.fromJson(json.decode(str));
...
final nacionalidadValues = EnumValues({
    "Mexicano": Nacionalidad.MEXICANO,
    " México": Nacionalidad.MXICO
});
